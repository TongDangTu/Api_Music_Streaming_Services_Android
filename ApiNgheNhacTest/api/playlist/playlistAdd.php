...
<?php
    ...
    if (empty($conn) == false) {
        ...
        try {
            ...
            $stmt = mysqli_prepare($conn,"INSERT INTO nghenhac.playlist (id,name,username) VALUES (?,?,?)");
            mysqli_stmt_bind_param($stmt, "sss", $id,$data_request->username, $data_request->password);
